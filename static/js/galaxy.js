// Liquid Ether Background - Ported to Vanilla JS
// Adapted from React Bits (DavidHDev)
...
// Global Instances
let Common, Mouse, paletteTex, bgVec4;
...
function initLiquidEther() {
  ...
  paletteTex = makePaletteTexture(config.colors);
  ...
  Object.assign(sim.options, config);
  sim.resize();
